...
- (void)configureAppearance
{
    ...
    NSArray *weekdaySymbols = useVeryShortWeekdaySymbols ? self.calendar.gregorian.veryShortStandaloneWeekdaySymbols : self.calendar.gregorian.veryShortStandaloneWeekdaySymbols;
